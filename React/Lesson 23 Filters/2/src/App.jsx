              ...
              <div className="filters">
                ...
                <div className='filters-left'>
                  ...
                  <div className='filter-price'>
                    <input type="number" className='filter-input' name='minPrice' onChange={handleChangePrice} placeholder='0' min={0} value={priceFilter.minPrice}/>
                    <input type="number" className='filter-input' name='maxPrice' onChange={handleChangePrice} placeholder='99999999' min={0} value={priceFilter.maxPrice}/>
                  </div>
                </div>
