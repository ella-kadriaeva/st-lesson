              ...
              <aside>
                  ...
                  <nav className='navbar'>
                    <ul className='navbar-list'>
                      <li><a href="" className='navbar-item navbar-item-active'>Рюкзаки</a></li>
                      <li><a href="" className='navbar-item'>Футболки</a></li>
                      <li><a href="" className='navbar-item'>Рубашки</a></li>
                    </ul>
                  </nav>
              </aside>
